...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <textarea class="form-control form-control-sm" name="alamat_edit" id="alamat_edit" cols="30" rows="10"><?php echo $guru['alamat'] ?></textarea>
    </div>
</div>
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn btn-xs btn-warning" id="editguru-btn"><span class="fas fa-plus mr-1"></span>Edit</button>
</div>
</form>