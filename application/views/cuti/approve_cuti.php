...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <select class="form-control form-control-sm" name="approve" id="approve">
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn btn-xs btn-primary" id="approvecuti-btn"><span class="fas fa-plus mr-1"></span>Simpan</button>
</div>
</form>