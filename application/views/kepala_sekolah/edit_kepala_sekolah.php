<?= form_open_multipart('#', ['id' => 'editkepsek']) ?>
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <input type="text" class="form-control form-control-sm" name="nama_edit" id="nama_edit" value="<?php echo $kepsek['nama_kepsek'] ?>">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <input type="text" class="form-control form-control-sm" name="username_kepsek_edit" id="username_kepsek_edit" disabled value="<?php echo $kepsek['username'] ?>">
    </div>
</div>

<div class="form-group row">
    <label for="password_kepsek_edit" class="col-sm-4 col-form-label">Password <font color="red">*</font></label>
    <div class="col-sm-8">
        <input type="password" class="form-control form-control-sm" name="password_kepsek_edit" id="password_kepsek_edit" value="<?php echo $kepsek['password'] ?>">
        <input type="checkbox" onclick="togglePasswordedit()"> Show Password
    </div>
    <input type="hidden" class="form-control form-control-sm" name="password_kepsek_old" id="password_kepsek_old" value="<?php echo $kepsek['password'] ?>">
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn btn-xs btn-primary" id="editkepsek-btn"><span class="fas fa-plus mr-1"></span>Edit</button>
</div>
</form>