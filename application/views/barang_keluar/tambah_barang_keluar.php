...
<div class="content-wrapper">
    <div class="card mb-4">
        <div class="card-header">
            <h4 style="color: black;" class="my-1">Tambah Data Barang Keluar</h4>
        </div>
        <div class="content-header">
            <div class="container-fluid">
                    ...
                    <div class="col-sm-8">
                        <select name="id_pelanggan" id="id_pelanggan" class="form-control form-control-sm">
                            ...
                            <?php foreach ($pelanggan->result() as $data) { ?>
                                <option value="<?php echo $data->id_pelanggan ?>" data-namapelanggan="<?php echo $data->nama_pelanggan; ?>"><?php echo $data->nama_pelanggan; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="date" class="form-control form-control-sm" name="tanggal_penjualan" id="tanggal_penjualan">
                    </div>
                </div>
                ...
                <div align="right">
                    ...
                    <button type="submit" class="btn btn-xs btn-primary" id="addbarangkeluar-btn"><span class="fas fa-plus mr-1"></span>Simpan</button>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $('#tambah_temp').click(function() {
            ...
            var jml_stok = $('#id_produk').find(':selected').data("jmlstok");
            ...
            if (qty > jml_stok) {
                swal.fire("Quantity Melebihi Stok!", "Quantity Tidak Dapat Melebihi Stok!", "error");
                return false;
            }
        ...
        $('#addbarangkeluar-btn').click(function() {
            ...
            if (table_data.length == 0) {
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "<?php echo base_url('index.php/barangkeluar/simpan'); ?>",
                            type: "POST",
                            crossOrigin: false,
                            dataType: 'json',
                            data: {
